...
function index()
    entry({"admin", "network", "vpn"}, alias("admin", "network", "vpn", "settings"), i18n[get_lang()].vpn, 50)
    entry({"admin", "network", "vpn", "settings"}, form("vpn/settings"), i18n[get_lang()].vpn_settings, 10)
